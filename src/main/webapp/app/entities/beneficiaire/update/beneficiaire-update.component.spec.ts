...
describe('Beneficiaire Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Virement query and add missing value', () => {
      ...
      const numCompte: IVirement = { id: 64623 };
      beneficiaire.numCompte = numCompte;
      ...
      const additionalVirements = [numCompte];
    ...
    it('Should update editForm', () => {
      const beneficiaire: IBeneficiaire = { id: 456 };
      const numCompte: IVirement = { id: 6185 };
      beneficiaire.numCompte = numCompte;
      ...
      expect(comp.virementsSharedCollection).toContain(numCompte);
    });
  });
