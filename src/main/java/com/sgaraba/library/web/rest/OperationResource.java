...
public class OperationResource {
    ...
    public ResponseEntity<Operation> updateOperation(
        ...
        Operation result = operationService.update(operation);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<Operation>> getAllOperations(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
