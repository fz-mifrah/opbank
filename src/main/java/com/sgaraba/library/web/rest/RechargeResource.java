...
public class RechargeResource {
    ...
    public ResponseEntity<Recharge> updateRecharge(
        ...
        Recharge result = rechargeService.update(recharge);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<Recharge> partialUpdateRecharge(
        ...
        Optional<Recharge> result = rechargeService.partialUpdate(recharge);
    ...
    public List<Recharge> getAllRecharges(
        ...
        if ("operation-is-null".equals(filter)) {
            ...
            return rechargeService.findAllWhereOperationIsNull();
        }
    ...
    public ResponseEntity<Recharge> getRecharge(@PathVariable Long id) {
        ...
        Optional<Recharge> recharge = rechargeService.findOne(id);
