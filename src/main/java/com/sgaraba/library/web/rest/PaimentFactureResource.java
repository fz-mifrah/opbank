...
public class PaimentFactureResource {
    ...
    public List<PaimentFacture> getAllPaimentFactures(@RequestParam(required = false) String filter) {
        ...
        return paimentFactureRepository.findAll();
    }
    ...
    public ResponseEntity<PaimentFacture> getPaimentFacture(@PathVariable Long id) {
        ...
        Optional<PaimentFacture> paimentFacture = paimentFactureRepository.findById(id);
