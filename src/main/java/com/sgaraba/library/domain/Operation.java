...
public class Operation implements Serializable {
    ...
    @OneToOne
    @JoinColumn(unique = true)
    @JsonIgnoreProperties(value = { "operateurs", "operation" }, allowSetters = true)
    @OneToOne
    @JoinColumn(unique = true)
    ...
    @JoinColumn(unique = true)
    @ManyToOne
    private Recharge typeOperation;
    ...
    @JoinColumn(unique = true)
    @ManyToOne
    private PaimentFacture typeOperation;
    ...
    public Recharge getTypeOperation() {
        return this.typeOperation;
    }

    public void setTypeOperation(Recharge recharge) {
        this.typeOperation = recharge;
    }

    public Operation typeOperation(Recharge recharge) {
        this.setTypeOperation(recharge);
        return this;
    }

    public PaimentFacture getTypeOperation() {
        return this.typeOperation;
    }

    public void setTypeOperation(PaimentFacture paimentFacture) {
        this.typeOperation = paimentFacture;
    }

    public Operation typeOperation(PaimentFacture paimentFacture) {
        this.setTypeOperation(paimentFacture);
        return this;
    }
