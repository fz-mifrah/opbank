...
public class Beneficiaire implements Serializable {
    ...
    public Virement getNumCompte() {
        return this.numCompte;
    }

    public void setNumCompte(Virement virement) {
        this.numCompte = virement;
    }

    public Beneficiaire numCompte(Virement virement) {
        this.setNumCompte(virement);
        return this;
    }
