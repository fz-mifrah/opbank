...
class CarteBancaireResourceIT {
    ...
    public static CarteBancaire createEntity(EntityManager em) {
        CarteBancaire carteBancaire = new CarteBancaire().numCompte(DEFAULT_NUM_COMPTE);
    ...
    public static CarteBancaire createUpdatedEntity(EntityManager em) {
        CarteBancaire carteBancaire = new CarteBancaire().numCompte(UPDATED_NUM_COMPTE);
        return carteBancaire;
    }
    ...
    void createCarteBancaire() throws Exception {
        ...
        assertThat(testCarteBancaire.getNumCompte()).isEqualTo(DEFAULT_NUM_COMPTE);
    }
    ...
    void checkNumCompteIsRequired() throws Exception {
        ...
        // set the field null
        carteBancaire.setNumCompte(null);
    ...
    void putNewCarteBancaire() throws Exception {
        ...
        updatedCarteBancaire.numCompte(UPDATED_NUM_COMPTE);
        ...
        CarteBancaire testCarteBancaire = carteBancaireList.get(carteBancaireList.size() - 1);
        assertThat(testCarteBancaire.getNumCompte()).isEqualTo(UPDATED_NUM_COMPTE);
    }
    ...
    void partialUpdateCarteBancaireWithPatch() throws Exception {
        ...
        partialUpdatedCarteBancaire.numCompte(UPDATED_NUM_COMPTE);
