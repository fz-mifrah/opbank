...
class VirementResourceIT {
    ...
    void createVirement() throws Exception {
        ...
        // Create the Virement
        restVirementMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(virement)))
    ...
    void putNewVirement() throws Exception {
        ...
        restVirementMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedVirement.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedVirement))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingVirement() throws Exception {
        ...
        restVirementMockMvc
            .perform(
                put(ENTITY_API_URL_ID, virement.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(virement))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamVirement() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restVirementMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(virement)))
    ...
    void patchNonExistingVirement() throws Exception {
        ...
        restVirementMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, virement.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(virement))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamVirement() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restVirementMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(virement)))
            .andExpect(status().isMethodNotAllowed());
