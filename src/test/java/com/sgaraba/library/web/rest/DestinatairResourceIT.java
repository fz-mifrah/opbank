...
class DestinatairResourceIT {
    ...
    void createDestinatair() throws Exception {
        ...
        restDestinatairMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(destinatair)))
    ...
    void putNewDestinatair() throws Exception {
        ...
        restDestinatairMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedDestinatair.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedDestinatair))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingDestinatair() throws Exception {
        ...
        restDestinatairMockMvc
            .perform(
                put(ENTITY_API_URL_ID, destinatair.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(destinatair))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamDestinatair() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restDestinatairMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(destinatair)))
    ...
    void patchNonExistingDestinatair() throws Exception {
        ...
        restDestinatairMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, destinatair.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(destinatair))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamDestinatair() throws Exception {
        ...
        restDestinatairMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(destinatair))
            )
            .andExpect(status().isMethodNotAllowed());
