...
class CompteResourceIT {
    ...
    public static Compte createEntity(EntityManager em) {
        Compte compte = new Compte().rib(DEFAULT_RIB).dateOuverture(DEFAULT_DATE_OUVERTURE).code(DEFAULT_CODE);
        return compte;
    }
    ...
    public static Compte createUpdatedEntity(EntityManager em) {
        Compte compte = new Compte().rib(UPDATED_RIB).dateOuverture(UPDATED_DATE_OUVERTURE).code(UPDATED_CODE);
        return compte;
    }
    ...
    void putNewCompte() throws Exception {
        ...
        updatedCompte.rib(UPDATED_RIB).dateOuverture(UPDATED_DATE_OUVERTURE).code(UPDATED_CODE);
    ...
    void fullUpdateCompteWithPatch() throws Exception {
        ...
        partialUpdatedCompte.rib(UPDATED_RIB).dateOuverture(UPDATED_DATE_OUVERTURE).code(UPDATED_CODE);
