...
describe('Transfer e2e test', () => {
  ...
  const transferSample = { cinDestinataireII: 'intranet Metal', nomPrenomDestinataireII: 'visualize Internal' };
  ...
  describe('new Transfer page', () => {
    ...
    it('should create an instance of Transfer', () => {
      cy.get(`[data-cy="cinDestinataireII"]`).type('Squares content-based Forward').should('have.value', 'Squares content-based Forward');

      cy.get(`[data-cy="nomPrenomDestinataireII"]`).type('backing').should('have.value', 'backing');

      cy.get(`[data-cy="telDestinataireII"]`).type('73301').should('have.value', '73301');
